...
//            .addPackage(TestConnectNativePackage())
        ...
        (mReactRootView as RNGestureHandlerEnabledRootView).startReactApplication(mReactInstanceManager, "NavigationPlayground", initialProperties)
